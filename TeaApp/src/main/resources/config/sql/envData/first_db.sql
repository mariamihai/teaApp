...
CREATE TABLE `tea_type` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_UNIQUE` (`name`),
  KEY `FK_tea_type_idx` (`id_category`),
  CONSTRAINT `FK_type_category` FOREIGN KEY (`id_category`) REFERENCES `tea_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-23 17:42:29
